...
in
{
  ...
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      # ========================
      # CONFIGURACIÓN LIGERA PARA HYPRLAND (COMPATIBLE CON NIX)
      # ========================
      ...
      # MONITORES
      # ========================
      monitor=HDMI-A-1,2560x1080@50,0x0,1
      ...
      # ========================
      # PROCESOS AL INICIO (SÓLO LO NECESARIO)
      # ========================
      exec-once = dbus-update-activation-environment --systemd DISPLAY XAUTHORITY WAYLAND_DISPLAY XDG_SESSION_DESKTOP XDG_CURRENT_DESKTOP XDG_SESSION_TYPE
      exec-once = hyprprofile Default
      exec-once = nm-applet
      exec-once = blueman-applet
      exec-once = waybar
      exec-once = emacs --daemon
      exec-once = hyprpaper  # Fondo de pantalla ligero
      ...
      # REGLAS DE VENTANAS
      # ========================
      windowrulev2 = float, class:^(pavucontrol|mpv|feh|thunar)$
      windowrulev2 = size 800 600, class:^(pavucontrol|mpv|feh)$
      windowrulev2 = opacity 0.85, class:^(firefox)$
      
      # ========================
      # XWAYLAND (COMPATIBILIDAD X11)
      # ========================
      xwayland {
      ...
      # ========================
      # OPTIMIZACIONES PARA NVIDIA (SI APLICA)
      # ========================
      exec-once = nvidia-settings -a "[gpu:0]/GPUPowerMizerMode=2"
