  ...
  outputs = inputs@{ self, ... }:
    let
      ...
      systemSettings = {
        ...
        hostname = "antonio"; # hostname
        profile = "personal"; # select a profile defined from my profiles directory
        timezone = "America/Mexico_City"; # select timezone
        locale = "es_MX.UTF-8"; # select locale
      ...
      userSettings = rec {
        ...
        name = "Antonio Ibarra"; # name/identifier
        email = "antonio.ibarra.g46@gmail.com"; # email (used for certain configurations)
        dotfilesDir = "/home/antonio/.dotfiles"; # absolute path of the local repo
        ...
        font = "IBM Plex"; # Selected font

        fontPkg = pkgs.ibm-plex; # Font package
